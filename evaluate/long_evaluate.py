...
"""
    ...
    client = OpenAI(api_key="sk-ftwqfqpthpvjczfbpfdklrxgicdyddtuxtetxhyjwvtxwqbu",
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ga_file', type=str,
                        ...
                        help="Generate answer filepath.")
    parser.add_argument('--output_file', type=str, default='', help="Save filepath.")
