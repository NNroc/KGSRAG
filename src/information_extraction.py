...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='home/npy/models/Qwen2.5-14B-Instruct',
    ...
    if dataset == 'medqa':
        ...
        all_corpus = os.listdir('./data/MedQA/textbooks/en')
        corpus = []
        for file_name in all_corpus:
            file_path = os.path.join('./data/MedQA/textbooks/en', file_name)
