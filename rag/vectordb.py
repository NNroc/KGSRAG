...
# copy from nano_vectordb import NanoVectorDB
...
class NanoVectorDB:
    ...
    def query(
        ...
        return self.usable_metrics[self.metric](query, top_k, better_than_threshold, filter_lambda=filter_lambda)
